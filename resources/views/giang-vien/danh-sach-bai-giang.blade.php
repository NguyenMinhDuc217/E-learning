...
<div class="class">
    ...
    <div class="show-group">
        <form action="{{route('xl-them-bai-giang-gv',['id'=>$lopHoc->id])}}" method="POST">
            @csrf
                    ...
                    <div class="header-post">
                        ...
                        <div class="icon-title-post">
                            ...
                            <div class="dropdown-menu ">
                                <a class="dropdown-item btn"  href="{{ route('sua-bai-giang',['id'=>$lopHoc->id, 'idbg'=>$b->id]) }}">Sửa</a>
                                <a class="dropdown-item btn" href="{{ route('xl-xoa-bai-giang',['id'=>$lopHoc->id, 'idbg'=>$b->id]) }}">Xóa</a>
                            </div>
                        </div>
                    </div>
