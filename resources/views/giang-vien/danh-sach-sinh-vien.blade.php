    ...
    padding: 1.5rem 1.5rem;">
        ...
        <div style="margin-bottom: 2rem;">
            <div class="title-header">
                ...
                <h4>{{$lopHoc->dstaiKhoanCho->count()}} sinh viên</h4>
            </div>
            <hr class="hr-ds">
            <table class="info-user">
                <tbody>
                    @foreach($lopHoc->dstaiKhoanCho as $lh)
                    <tr class="list-info-sv">
                        ...
                        <td class="function">
                            ...
                            <div class="dropdown-menu dropdownn-menu-left">
                                <a class="dropdown-item btn" href="{{route('xl-duyet-tham-gia',['idLop'=>$lopHoc->id,'idSv'=>$lh->id])}}">Duyệt</a>
                                <a class="dropdown-item btn" href="{{route('xl-xoa-duyet-tham-gia',['idLop'=>$lopHoc->id,'idSv'=>$lh->id])}}">Kick</a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
