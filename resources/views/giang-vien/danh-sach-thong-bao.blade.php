...
<div class="class">
    ...
    <div class="show-group">
        <div class="form-show">
            <form action="{{route('xl-them-bai-tb-gv',['id'=>$lopHoc->id])}}" method="POST">
                    @csrf
                ...
                <div class="main-post">
                    <div class="header-post">
                        ...
                        <div class="icon-title-post">
                            ...
                            <a class="dropdown-item btn"  href="{{ route('sua-bai-tb',['id'=>$lopHoc->id, 'idtb'=>$b->id]) }}">Sửa</a>
                            <a class="dropdown-item btn" href="{{ route('xl-xoa-bai-tb',['id'=>$lopHoc->id, 'idtb'=>$b->id]) }}">Xóa</a>
                            </div>
                        </div>
                    </div>
